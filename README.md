...
- [calit](https://asm0dey.github.io/calit/) - Free appointment scheduling with Google Calendar integration. ([Source Code](https://github.com/asm0dey/calit)) `AGPL-3.0` `Java/Docker`
